...
public class InstaTag extends RelativeLayout {
    ...
    private void initViewWithId(Context context, TypedArray obtainStyledAttributes) {
        ...
        //mRoot.getLayoutParams().height = 1800;
        ...
        if (isTagged(tagText)) {
            ...
            RelativeLayout.LayoutParams layoutParams =
                    new RelativeLayout.LayoutParams(
                            ...
                            RelativeLayout.LayoutParams.WRAP_CONTENT);
            /*layoutParams.
                    setMargins(x - tagTextView.length() * 2,
                            y - tagTextView.length() * 2,
                            x - tagTextView.length() * 2,
                            0);*/
            tagView.setX(x);
            tagView.setY(y);
            ...
            if (canWeAddTags) {
                ...
                tagTextView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!loginusername.equalsIgnoreCase("")) {
                            if (loginusername.equalsIgnoreCase("" + name)) {
                                Intent i1 = null;
                                try {
                                    i1 = new Intent(getContext(), Class.forName("com.TBI.Client.Bluff.Activity.Profile.ProfilePage"));
                                ...
                                Intent i1 = null;
                                try {
                                    i1 = new Intent(getContext(), Class.forName("com.TBI.Client.Bluff.Activity.Profile.OtherUserProfile"));
                                    i1.putExtra("other_id", "");
                                    i1.putExtra("other_username", name);
                                    getContext().startActivity(i1);
                                    ((Activity) getContext()).overridePendingTransition(R.anim.fade_in, R.anim.stay);
                                } catch (ClassNotFoundException e) {
                                    e.printStackTrace();
                        ...
                        Log.d("mn13name:", ((TextView) v).getText().toString());
                    }
                });
            }
        } else {
...
*/
    ...
    public void removeTags(String tagText) {
        if (!mTagList.isEmpty()) {
            for (int i = 0; i < mTagList.size(); i++) {
                if (((TextView) mTagList.get(i).findViewById(R.id.tag_text_view)).getText().toString().equalsIgnoreCase(tagText)) {
                    mRoot.removeView(mTagList.get(i));
                    mTagList.remove(i);
