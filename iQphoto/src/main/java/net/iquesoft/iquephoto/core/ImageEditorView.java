...
//                                mImageBitmap.getWidth(), // Width
//                                mImageBitmap.getHeight(), // Height
//                                Bitmap.Config.ARGB_8888 // Config
//                        );
//                        mImageBitmap = dstBitmap;
//                        Rect dstRect = new Rect();
//                        canvas.getClipBounds(dstRect);
                        canvas.drawBitmap(mImageBitmap, canvas.getMatrix(), mBitmapPaint);
                    } else {
                        canvas.drawBitmap(bitmap, mImageMatrix, mBitmapPaint);
                    }
                    break;
...
//                    break;
    ...
    public void setImageBitmap1(@NonNull Bitmap bitmap) {
        Log.i(TAG, "setImageBitmap(...)");
        mImageBitmap = bitmap;
        mPresenter.setupBitmapOnView(mImageBitmap, getWidth(), getHeight());
    }
    ...
    public void addText(Text text, FragmentActivity activity) {
        mPresenter.addText(text,activity);
    }
    ...
    public void setBlurIntencity(@IntRange(from = -100, to = 100) int value) {
        mPresenter.changeVignetteMask(value);
    }
