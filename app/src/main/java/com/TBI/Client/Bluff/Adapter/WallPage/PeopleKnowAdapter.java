...
public class PeopleKnowAdapter extends RecyclerView.Adapter<PeopleKnowAdapter.MyClassView> {

    Activity context;
    List<PersonYouKnow> personYouKnows;
    private ArrayList<Integer> account_privacy = new ArrayList<>();

    public PeopleKnowAdapter(Activity context, List<PersonYouKnow> personYouKnows) {
    ...
    public void onBindViewHolder(@NonNull MyClassView holder, int position) {
        PersonYouKnow nearBy = personYouKnows.get(position);
    ...
    public int getItemCount() {
        return personYouKnows.size();
    }

    public void Send_Request(int pos) {
