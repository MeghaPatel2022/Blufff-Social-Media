...
public class Postdetail_ImageAdapter extends PagerAdapter {
    public static boolean showinstag = true;
    List<Image> images = new ArrayList<>();
    float oldwidth, oldheight, height, width;
    private LayoutInflater inflater;
    private Context context;

    public Postdetail_ImageAdapter(Context context, List<Image> images, float height1, float width1, float newheight, float newwidth) {
