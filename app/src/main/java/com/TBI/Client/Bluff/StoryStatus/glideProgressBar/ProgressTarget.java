...
public abstract class ProgressTarget<Image_, Z> extends WrappingTarget<Z> implements OkHttpProgressGlideModule.UIProgressListener {
    private com.TBI.Client.Bluff.Model.GetFeed.Image_ model;
    ...
    public ProgressTarget(com.TBI.Client.Bluff.Model.GetFeed.Image_ model, Target<Z> target) {
        super(target);
        this.model = model;
    }

    public final com.TBI.Client.Bluff.Model.GetFeed.Image_ getModel() {
        return model;
    }

    public final void setModel(com.TBI.Client.Bluff.Model.GetFeed.Image_ model) {
     ...
     */
    protected String toUrlString(com.TBI.Client.Bluff.Model.GetFeed.Image_ model) {
    ...
    private void start() {
        OkHttpProgressGlideModule.expect(model.getFilename(), this);
    ...
    private void cleanup() {
        ignoreProgress = true;
        com.TBI.Client.Bluff.Model.GetFeed.Image_ model = this.model; // save in case it gets modified
        onDelivered();
        OkHttpProgressGlideModule.forget(model.getFilename());
        //this.model = null;
    }
