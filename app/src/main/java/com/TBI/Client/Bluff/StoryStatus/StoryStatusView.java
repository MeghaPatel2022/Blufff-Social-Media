...
public class StoryStatusView extends LinearLayout {
    ...
    boolean isReverse;
    boolean isComplete;
    StatusStoriesActivity statusStoriesActivity;
    ...
    public void setactivity(StatusStoriesActivity statusStoriesActivity) {
        this.statusStoriesActivity = statusStoriesActivity;
    }
    ...
    private ObjectAnimator createAnimator(final int index, long duration) {
        ...
        animation.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                statusStoriesActivity.checkapicall(current);
                if (isReverse) {
                    isReverse = false;
