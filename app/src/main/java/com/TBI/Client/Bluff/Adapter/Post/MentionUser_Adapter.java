...
import com.TBI.Client.Bluff.Model.GetHashTagUser.User;
...
public class MentionUser_Adapter extends SocialArrayAdapter<User> {

    Context context1;

    public MentionUser_Adapter(Context context) {
    ...
    @NonNull
    @Override
    public CharSequence convertToString(User object) {
