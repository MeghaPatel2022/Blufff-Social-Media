...
public class AllUserAdapter extends RecyclerView.Adapter<AllUserAdapter.MyClassView> {

    List<AllUsers> friendsList;
    Activity activity;

    public AllUserAdapter(List<AllUsers> friendsList, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull MyClassView holder, int position) {
        AllUsers friends = friendsList.get(position);
