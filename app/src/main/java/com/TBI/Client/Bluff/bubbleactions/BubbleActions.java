...
import static com.TBI.Client.Bluff.Fragment.Look_Fragment.demo_adapter;
...
public final class BubbleActions {
    ...
    public View.OnDragListener overlayDragListener = new View.OnDragListener() {
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (action) {
                case DragEvent.ACTION_DRAG_STARTED:
                    //   v.setBackgroundTintList(ColorStateList.valueOf(RM.color.textcolor));
                    ...
                    overlay.getAnimateSetHide()
                            .setListener(new ViewPropertyAnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(View view) {
                                    super.onAnimationEnd(view);
                                    removeOverlay();
                                    demo_adapter.setpostion(-1);
                                    /*if (Look_Fragment.lnforeground != null) {

                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                            Look_Fragment.lnforeground.getForeground().setAlpha(0);
                                        }

                                    }*/
                                    /*

                                    if (Look_Fragment.lnforeground1 != null) {

                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                            Look_Fragment.lnforeground1.getForeground().setAlpha(0);
                                        }
    ...
    public BubbleActions(ViewGroup root) {
        this.indicator = getDrawable(root.getResources(), R.drawable.bubble_indicator, root.getContext().getTheme());
        this.root = root;
    ...
    public BubbleActions withIndicator(int indicatorRes) {
        this.indicator = getDrawable(root.getResources(), indicatorRes, root.getContext().getTheme());
        return this;
    }
    ...
    public BubbleActions addAction(CharSequence actionName, int drawableRes, Callback callback) {
        ...
        addAction(actionName, getDrawable(resources, drawableRes, theme), callback);
        return this;
    }
