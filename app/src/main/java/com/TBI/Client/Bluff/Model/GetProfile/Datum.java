...
public class Datum implements Serializable {
    ...
    private final static long serialVersionUID = -7391251332834841315L;
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("userType", userType).append("cover",coverPhoto).append("photo", photo).append("username", username).append("fullName", fullName).append("professionId", professionId).append("bio", bio).append("email", email).append("gender", gender).append("mobileCode", mobileCode).append("mobileNo", mobileNo).append("password", password).append("status", status).append("accountPrivacy", accountPrivacy).append("otp", otp).append("otpSession", otpSession).append("token", token).append("createdAt", createdAt).append("updatedAt", updatedAt).append("rateAvg", rateAvg).toString();
    }
