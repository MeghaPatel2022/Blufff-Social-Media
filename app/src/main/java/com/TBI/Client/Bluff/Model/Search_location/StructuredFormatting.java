...
public class StructuredFormatting {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("mainText", mainText).append("mainTextMatchedSubstrings", mainTextMatchedSubstrings).append("secondaryText", secondaryText).toString();
    }
