...
public class FollowingProfAdapter extends RecyclerView.Adapter<FollowingProfAdapter.MyClassView> {

    private List<A> aList = new ArrayList<>();
    private Activity context;

    public FollowingProfAdapter(List<A> aList, Activity context) {
        this.aList = aList;
