...
public class FriendList_Adapter extends BaseAdapter {
    ...
    List<Friend> recentlyaddedlist = new ArrayList<>();
    ...
    public FriendList_Adapter(Context context, List<Friend> recentlyaddedlist) {
...
//                mViewHolder.txtfolllow.setBackground(context.getResources().getDrawable(R.drawable.follow_box));
                ...
                mViewHolder.txtfolllow.setBackgroundTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.follow_accept_color)));
    ...
    public void Addall(List<Friend> freindlist) {
        recentlyaddedlist = new ArrayList<>();
        recentlyaddedlist.addAll(freindlist);
        notifyDataSetChanged();
    }

    public void Send_Request(Friend friend) {
