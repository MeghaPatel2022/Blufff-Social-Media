...
public class ChatListAdapter extends AlFooterAdapter implements AdapterView.OnItemClickListener {
    ...
    public ChatListAdapter(Context context, List<Message> mList, Talk_Fragment talk_fragment) {
        super(context, mList);
    ...
    public RecyclerView.ViewHolder getConversationViewHolder(ViewGroup parent) {
        return new ConversationViewHolder(mInflater.inflate(R.layout.list_frend_chat, parent, false));
    }
...
//        ImageView attachmentIcon;
        ...
        public ConversationViewHolder(View view) {
            ...
            receiverName = view.findViewById(R.id.txtusername);
//            messageTv = view.findViewById(RM.id.message);
//            unreadCount = view.findViewById(RM.id.unreadSmsCount);
//            createdAtTime = view.findViewById(RM.id.createdAtTime);
