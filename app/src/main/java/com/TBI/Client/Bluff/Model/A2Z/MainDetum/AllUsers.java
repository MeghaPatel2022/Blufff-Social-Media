package com.TBI.Client.Bluff.Model.A2Z.MainDetum;
...
public class AllUsers {
    ...
    @SerializedName("r")
    @Expose
    private List<RM> r = new ArrayList<>();
    @SerializedName("s")
    @Expose
