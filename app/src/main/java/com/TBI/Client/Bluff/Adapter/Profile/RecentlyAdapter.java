...
import com.TBI.Client.Bluff.Adapter.Profile.FriendsFollowers.FollowingProfAdapter;
...
public class RecentlyAdapter extends RecyclerView.Adapter<RecentlyAdapter.MyClassView> {

    List<RecentUsers> friendsList = new ArrayList<>();
    Activity activity;

    public RecentlyAdapter(List<RecentUsers> friendsList, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull MyClassView holder, int position) {
        RecentUsers friends = friendsList.get(position);
