...
public class FollowingAAdapter extends RecyclerView.Adapter<FollowingAAdapter.MyClassView> {

    List<Following> friendsList;
    Activity activity;

    public FollowingAAdapter(List<Following> friendsList, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull MyClassView holder, int position) {
        Following friends = friendsList.get(position);
