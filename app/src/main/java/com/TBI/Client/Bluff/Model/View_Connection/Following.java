...
public class Following implements Serializable {
    ...
    private final static long serialVersionUID = -1329679167287183540L;
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public Following(Integer id, String username, String fullName, String photo, Integer followedBy, Integer followByFollowing) {
        this.id = id;
