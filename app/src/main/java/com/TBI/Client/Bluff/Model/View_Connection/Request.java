...
public class Request implements Serializable {
    ...
    private final static long serialVersionUID = 6584066671489934849L;
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public Request(Integer id, String username, String fullName, String photo, Integer followedBy, Integer followByFollowing) {
        this.id = id;
