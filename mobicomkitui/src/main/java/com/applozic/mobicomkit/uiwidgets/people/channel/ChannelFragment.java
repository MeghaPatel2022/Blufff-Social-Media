...
// Create a new DisplayMetrics object
    ...
    private class ChannelAdapter extends CursorAdapter implements SectionIndexer {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            ...
            holder.groupName = itemLayout.findViewById(R.id.applozic_group_name);
            holder.totalmembers = itemLayout.findViewById(R.id.applozic_group_members);
            holder.groupIcon = itemLayout.findViewById(R.id.contactImage);
