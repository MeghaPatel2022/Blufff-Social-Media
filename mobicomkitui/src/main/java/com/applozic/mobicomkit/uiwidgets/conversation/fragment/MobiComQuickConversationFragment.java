...
public class MobiComQuickConversationFragment extends Fragment implements SearchListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loading = true;
        LinearLayout individualMessageSendLayout = list.findViewById(R.id.individual_message_send_layout);
        LinearLayout extendedSendingOptionLayout = list.findViewById(R.id.extended_sending_option_layout);
                    ...
                    try {
                        ...
                        if (message != null) {
                            ...
                            if (view != null && contact != null) {
                                ImageView contactImage = view.findViewById(R.id.contactImage);
                                TextView displayNameTextView = view.findViewById(R.id.smReceivers);
                ...
                try {
                    ...
                    if (message != null) {
                        ...
                        if (index != -1) {
                            View view = recyclerView.getChildAt(index - linearLayoutManager.findFirstVisibleItemPosition());
                            if (view != null) {
                                TextView unreadCountTextView = view.findViewById(R.id.unreadSmsCount);
