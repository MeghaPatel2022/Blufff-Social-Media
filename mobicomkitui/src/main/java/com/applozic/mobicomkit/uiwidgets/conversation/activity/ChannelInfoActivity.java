...
public class ChannelInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Applozic logic = new Applozic(ChannelInfoActivity.this);

        if (Applozic.getTheme(ChannelInfoActivity.this).equalsIgnoreCase("white")) {
        ...
        channelDeleteRelativeLayout = findViewById(R.id.channel_delete_relativeLayout);
        channelExitRelativeLayout = findViewById(R.id.channel_exit_relativeLayout);
        collapsingToolbarLayout = findViewById(R.id.toolbar_layout);
        Typeface myFont = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            myFont = getResources().getFont(R.font.poppins_semibold);
            collapsingToolbarLayout.setCollapsedTitleTypeface(myFont);
            collapsingToolbarLayout.setExpandedTitleTypeface(myFont);
        }
        ...
        /*if (Applozic.getTheme(ChannelInfoActivity.this).equalsIgnoreCase("black")) {*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_member_to_channel) {
            if (isUserPresent) {
                ...
                try {
                    Intent myIntent = new Intent(this, Class.forName("com.TBI.Client.Bluff.Activity.AddContactToGroup"));
                    myIntent.putExtra("channel", (Serializable) channelUserMapperList);
                    startActivityForResult(myIntent, REQUEST_CODE_FOR_CONTACT);
    ...
    public void removeChannelUser(final Channel channel, final ChannelUserMapper channelUserMapper) {
        ...
        txtdelete.setText(getResources().getString(R.string.remove_member));
        ...
        txtmsg.setText(getString(R.string.dialog_remove_group_user).replace(getString(R.string.user_name_info), name).replace(getString(R.string.group_name_info), channelName));
    ...
    public void addChannelUser(final String userId, final Channel channel) {
        ...
        txttitle = dialogLayout.findViewById(R.id.txttitle);
        txtmsg = dialogLayout.findViewById(R.id.txtmsg);
        txtdelete.setText(getResources().getString(R.string.add));
        txttitle.setVisibility(View.GONE);
        ...
        txtmsg.setText(getString(R.string.dialog_add_group_user).replace(getString(R.string.user_name_info), name).replace(getString(R.string.group_name_info), channelName));
        alertDialog.setCancelable(true);
        alertDialog.show();
    }
    ...
    public void leaveChannel(final Channel channel) {
        ...
        txttitle = dialogLayout.findViewById(R.id.txttitle);
        txtmsg = dialogLayout.findViewById(R.id.txtmsg);
        txtdelete.setText(getResources().getString(R.string.channel_exit));
        txttitle.setVisibility(View.GONE);
        ...
        if (channel.getType() != null) {
            txtmsg.setText(getString(R.string.leave_channel).replace(getString(R.string.groupType_info), Channel.GroupType.BROADCAST.getValue().equals(channel.getType()) ? getString(R.string.broadcast_string) : getString(R.string.group_string)));
        }
        alertDialog.setCancelable(true);
        alertDialog.show();
    }
    ...
    public void deleteChannel(final Channel channel) {
        ...
        txttitle = dialogLayout.findViewById(R.id.txttitle);
        txtmsg = dialogLayout.findViewById(R.id.txtmsg);
        txtdelete.setText(getResources().getString(R.string.channel_deleting));
        txttitle.setVisibility(View.GONE);
    ...
    private class ContactsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                holder.circleImageView.setClipToOutline(true);
            }
            if (contact != null) {
            ...
            if (!TextUtils.isEmpty(responseForDeleteGroup) && SUCCESS.equals(responseForDeleteGroup)) {
                try {
                    if (!TextUtils.isEmpty(alCustomizationSettings.getGroupDeletePackageName())) {
                        ...
                        try {
                            Intent myIntent = new Intent(ChannelInfoActivity.this, Class.forName("com.TBI.Client.Bluff.BottombarActivity"));
                            myIntent.putExtra("type", "chat");
