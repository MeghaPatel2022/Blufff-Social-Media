...
public class ConversationScheduler extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final TextView scheduledDate = conversationScheduler.findViewById(R.id.scheduledDate);
        final TextView scheduledTime = conversationScheduler.findViewById(R.id.scheduledTime);
