...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        img_profile = view.findViewById(R.id.applozic_user_profile);
        statusEdit = view.findViewById(R.id.status_edit_btn);
        displayNameEdit = view.findViewById(R.id.displayName_edit_btn);
        contactEdit = view.findViewById(R.id.contact_edit_btn);
        selectImageProfileIcon = view.findViewById(R.id.applozic_user_profile_camera);
        logoutbtn = view.findViewById(R.id.applozic_profile_logout);
        displayNameText = view.findViewById(R.id.applozic_profile_displayname);
        statusText = view.findViewById(R.id.applozic_profile_status);
        contactNumberText = view.findViewById(R.id.applozic_profile_contact);
        applozicProfileContactLayout = view.findViewById(R.id.applozic_profile_contact_section_rl);
...
//        toolbar.setSubtitle("");
    ...
    private void setupDeviderView(View view, int parentLayout, int childVerticalLineLayout) {
        final RelativeLayout layout = view.findViewById(parentLayout);
        final RelativeLayout childLayout = view.findViewById(childVerticalLineLayout);
