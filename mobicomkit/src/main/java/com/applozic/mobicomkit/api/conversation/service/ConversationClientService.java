...
public class ConversationClientService extends MobiComKitClientService {
    ...
    public Conversation getConversation(Integer conversationId) {
        ...
        try {
            if (conversationId != null) {
                response = httpRequestUtils.getResponse(getConversationUrl() + "?id=" + conversationId, "application/json", "application/json");
    ...
    public String closeConversation(Integer conversationId) {
        ...
        try {
            if (conversationId != null) {
                response = httpRequestUtils.getResponse(getConversationCloseUrl() + "?id=" + conversationId, "application/json", "application/json");
