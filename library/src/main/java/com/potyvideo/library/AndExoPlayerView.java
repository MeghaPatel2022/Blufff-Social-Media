...
public class AndExoPlayerView extends LinearLayout implements View.OnClickListener {
    ...
    public class ComponentListener implements Player.EventListener {
        ...
        public void onPlayerError(ExoPlaybackException error) {
            showRetry();
            Log.e("LLLLLL_Error: ",error.getMessage());
    ...
    public void setVolume(float v) {
        // mute
        if (simpleExoPlayer != null)
            Objects.requireNonNull(simpleExoPlayer.getAudioComponent()).setVolume(0);
//        simpleExoPlayer.selectTrack(FullPlayer.TYPE_AUDIO, ExoPlayer.TRACK_DISABLED);
//        if (simpleExoPlayer != null)
